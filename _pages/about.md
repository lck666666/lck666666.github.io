...
<span class='anchor' id='about-me'></span>
 ...
 I received Ph.D. degree in Computer Science and Engineering at the [Hong Kong University of Science and Technology](https://hkust.edu.hk/). I previously worked as a research intern at [Google](https://blog.google/products-and-platforms/platforms/android/android-xr/) and [Ant Research](https://www.antresearch.com/LaboratoryDetails/Intelligent_Interaction_Lab-detail). I was fortunate to visit the [Active Vision Laboratory](https://www.robots.ox.ac.uk/~lav/), [University of Oxford](https://www.ox.ac.uk/). I received my bachelor's degree from [Shanghai Jiao Tong University](https://en.sjtu.edu.cn/). Research Focus: Visual Localization, 3D Reconstruction, and AR/VR.


# 🔥 News
- *2026.09*: &nbsp;🎉🎉 [OpenNavMap](https://openreview.net/pdf?id=zmTTpkbrvv) is accepted to TRO (IEEE Transactions on Robotics)! Thanks to all coauthors!
...
[**[Project]**](https://lck666666.github.io/plana3r/)  [**[Code]**](https://github.com/lck666666/plana3r)![GitHub Stars](https://img.shields.io/github/stars/lck666666/plana3r?style=social) <strong><span class='show_paper_citations' data='DhtAFkwAAAAJ:ALROH1vI_8AC'></span></strong>
...
# Academic Service
- Reviewer: ICLR, NeurIPS, CVPR, ECCV, AAAI, IROS, ICRA, RA-L, KBS, TVCG
...
<body>
    ...
    <div class="map-container">
        <script type="text/javascript" id="mapmyvisitors" src="//mapmyvisitors.com/map.js?d=cHMXAy9vCSMBfvq_2BAJ3qTMgQV7nq87G_hPNmoke5c&cl=ffffff&w=a"></script>
    </div>
